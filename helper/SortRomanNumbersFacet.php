...
class sortRomanNumbersFacet extends AbstractHelper
{
    public function __invoke(array $facetValues) 
    {	
		usort($facetValues, [sortRomanNumbersFacet::class, "cmp"]);		
		return $facetValues;
    }

	static function cmp($a, $b){
		return self::Roman2Int($a["value"]) - self::Roman2Int($b["value"]);
	}

	// https://stackoverflow.com/questions/6265596/how-to-convert-a-roman-numeral-to-integer-in-php/6291089#6291089
